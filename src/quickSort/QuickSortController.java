...
public class QuickSortController implements Initializable {
    ...
    private QuickSort insertionSort;
    private QuickSortAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, QuickSort insertionSort) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new QuickSortAlgorithm(input, statusLabel, visualBox, arrayInputField, generateButton,
    ...
    public void helpButton() {
        infoWindow info = new infoWindow("Quick Sort");
    }
}
