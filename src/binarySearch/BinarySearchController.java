...
public class BinarySearchController implements Initializable {
    ...
    private BinarySearchAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, BinarySearch binarySearch) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new BinarySearchAlgorithm(input, statusLabel, visualBox, arrayInputField, generateButton, searchButton,
    ...
    public void helpButton() {
        infoWindow info = new infoWindow("Binary Search");
    }
}
