...
/**
 * Creates and handles all action in the binary search scene.
...
public class BinarySearchAlgorithm {
    ...
    public BinarySearchAlgorithm(String input, Label statusLabel, VBox visualBox, TextField inputField, Button generateButton,
    ...
    /**
     * Does binary search on this array and creates visuals during this.
     */
    ...
    private void doBinarySearch() {
        ...
        comparisons++;
        while(left <= right && array[middle] != numberToSearch) {
            comparisons++;
            VisualizeArray vis = new VisualizeArray(visualBox);
            vis.initArray(array);
            vis.setInFocus(middle);
