 ...
 */
public class RadixSortController implements Initializable {

    private CustomStage window;
    private Parent prevScene;
    private RadixSort insertionSort;
    private RadixSortAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, RadixSort insertionSort) {
        this.window = window;
