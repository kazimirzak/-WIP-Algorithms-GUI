...
public class BubbleSortController implements Initializable {
    ...
    private BubbleSort insertionSort;
    private BubbleSortAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, BubbleSort insertionSort) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new BubbleSortAlgorithm(input, statusLabel, visualBox, arrayInputField, generateButton,
    ...
    public void helpButton() {
        infoWindow info = new infoWindow("Bubble Sort");
    }
}
