...
public class BubbleSort {
    ...
    public BubbleSort(CustomStage window) {
        this.window = window;
    ...
    public Parent getScene() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("BubbleSortFXML.fxml"));
        Parent root = null;
        try {
            root = loader.load();
            BubbleSortController controller = loader.getController();
