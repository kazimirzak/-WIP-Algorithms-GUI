...
public class HeapSort {
    ...
    public HeapSort(CustomStage window) {
        this.window = window;
    ...
    public Parent getScene() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("HeapSortFXML.fxml"));
        Parent root = null;
        try {
            root = loader.load();
            HeapSortController controller = loader.getController();
