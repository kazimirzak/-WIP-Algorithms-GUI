...
public class InsertionSortController implements Initializable {
    ...
    private InsertionSortAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, InsertionSort insertionSort) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new InsertionSortAlgorithm(input, statusLabel, visualBox, arrayInputField, generateButton,
    ...
    public void helpButton() {
        infoWindow info = new infoWindow("Insertion Sort");
    }
}
