...
public class MergeSortController implements Initializable {
    ...
    private MergeSort insertionSort;
    private MergeSortAlgorithm visualizer;
    ...
    @FXML
    private VBox inputBox, leftBox, rightBox, visualBox;
    ...
    public void setWindow(CustomStage window, Parent prevScene, MergeSort insertionSort) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new MergeSortAlgorithm(input, statusLabel, visualBox, inputBox, leftBox, rightBox, inputLabelContainer, leftLabelContainer,
                rightLabelContainer, arrayInputField, generateButton, toStart, toEnd, forward, backward, playPause, speedSlider);
    }
    ...
    public void helpButton() {
        infoWindow info = new infoWindow("Merge Sort");
    }
}
