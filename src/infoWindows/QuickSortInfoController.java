 ...
 */
public class QuickSortInfoController implements Initializable {
    ...
    private void initPathList() {
        ...
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\quickSort.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\arrayInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\generateText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\resetText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\playPauseText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\backwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\forwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\toStartText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\quickSort\\toEndText.txt");
    }
