 ...
 */
public class HeapSortInfoController implements Initializable {
    ...
    @FXML
    private Text textArea, arrayInputFieldText, generateText, resetText, playPauseText, backwardText, forwardText, toStartText, toEndText, heapTypeText;
    ...
    private void initPathList() {
        ...
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\heapSort.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\heapType.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\arrayInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\generateText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\resetText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\playPauseText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\backwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\forwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\toStartText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\heapSort\\toEndText.txt");
    }
    ...
    private void css() {
        ...
        //css for the combo box
        heapType.getStyleClass().add("info-combo-box");
