 ...
 */
public class LinearSearchInfoController implements Initializable {
    ...
    private void initPathList() {
        ...
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\linearSearch.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\arrayInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\searchInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\generateText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\resetText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\searchText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\playPauseText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\backwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\forwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\toStartText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\linearSearch\\toEndText.txt");
    }
