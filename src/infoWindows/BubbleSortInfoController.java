 ...
 */
public class BubbleSortInfoController implements Initializable {
    ...
    private void initPathList() {
        ...
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\bubbleSort.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\arrayInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\generateText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\resetText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\playPauseText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\backwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\forwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\toStartText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\bubbleSort\\toEndText.txt");
    }
