 ...
 */
public class CountingSortInfoController implements Initializable {
    ...
    private void initPathList() {
        ...
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\countingSort.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\arrayInputFieldText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\generateText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\resetText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\playPauseText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\backwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\forwardText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\toStartText.txt");
        pathForTexts.add(System.getProperty("user.dir") + "\\src\\infoWindows\\info\\countingSort\\toEndText.txt");
    }
