 ...
 */
public class CountingSortController implements Initializable {

    private CustomStage window;
    private Parent prevScene;
    private CountingSort insertionSort;
    private CountingSortAlgorithm visualizer;
    ...
    public void setWindow(CustomStage window, Parent prevScene, CountingSort insertionSort) {
        this.window = window;
    ...
    public void generateButton() {
        ...
        visualizer = new CountingSortAlgorithm(input, statusLabel, visualBox, inputBox, countingBox, outputBox, inputLabelContainer, countingLabelContainer,
